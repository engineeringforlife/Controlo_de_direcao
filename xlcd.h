...
#define CLEAR_LCD   0b00000001  /* Clear LCD       */
...
/* Endereçamentos */
#define LINE1CLUN1 0b10000000   /*LINHA 1 COLUNA 1*/
#define LINE2CLUN1 0b11000000   /*LINHA 2 COLUNA 1*/
#define CARACTER_C 0b00000000   /*Endereço do caracter Ç*/



#define PARAM_SCLASS 
#define MEM_MODEL   /* Change this to near for small memory model */
 ...
 */
void putrsXLCD(PARAM_SCLASS const MEM_MODEL char *);

void CGRamAddr0 (void);     //Cria o caracter Ç
